...
export default function TimetableGuide() {
    ...
    return (
      ...
      <section>
        ...
        特にこだわりがなければ評価がA以上のものを中心に選ぶことをおすすめします。人気の授業は抽選で外れやすいのもあるので確実に授業を受けたい人は何個かはB以下のものを混ぜるのもありですが、できれば1〜2個までに抑えましょう。
        抽選希望の際には同じ時間に複数希望を出すことも可能なので、般教を選ぶ時は時間被りを気にしなくて大丈夫です。
        目安としては受けたい数の2倍ぐらい、抽選に出したい授業を決めておきましょう。当選希望数を自由に決められるので、多すぎて困ることはありません。</p>
      </section>
   </div>
    );
}
